...
<head>
    ...
    <script>
        function changepw() {
            $("#inputPassword2").val(hex_md5($("#inputPassword2").val()));
...
<div class="jumbotron">
    <div style="width: 1366px; margin: auto;text-align: center">
        <h1 style="padding-right: 75px">欢迎注册U钱包</h1>
    </div>
</div>
<div style="width: 1000px; margin: auto;text-align: center">
    <form id="sign_form" class="form-horizontal" action="" method="post">
        ...
        <div class="form-group"  style="width: 500px; margin:15px auto; ">
            ...
            <div class="col-sm-10" >
                <input style="width: 200px; display: inline;float:left" type="text" class="form-control" id="inputEmail4" placeholder="请输入6位手机验证码">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10" style="margin-left: 80px">
                <button type="button" class="btn btn-default" style="width: 300px; margin-left: 0px" onclick="changepw()">注册</button>
            </div>
        </div>
    </form>
</div>
